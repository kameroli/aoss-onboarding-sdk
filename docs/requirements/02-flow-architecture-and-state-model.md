...
**Document:** SDK-REQ-02 | **Maps to:** Application Outcome & Status Standard (AOSS) v0.1.0 (Draft for Comment), SPEC.md + openapi.yaml as published at kameroli/aoss | **Status:** Draft | **Date:** September 1, 2026 | **Rev:** 3 (Rev 2: contact verification re-scoped institution-side; SG-04 added. Rev 3: reconciled to openapi.yaml v0.1.0 — §0.1 contract verification and §0.2 Standard feedback register added; `started` re-scoped client-local; withdraw and pre-submission resumability revised)
